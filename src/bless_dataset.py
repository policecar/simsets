...
svo_dt =                basedir + 'sim/sim.gz';
svo_flipped_dt =        basedir + 'sim/sim_flipped.gz';

svo_lda_w2t =           basedir + 'lda/model_final_doc2topic_5_5';
svo_flipped_lda_w2t =   basedir + 'lda/model_final_doc2topic_5_5_flipped';
